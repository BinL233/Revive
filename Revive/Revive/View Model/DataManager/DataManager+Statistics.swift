...
extension DataManager {
    ...
    func loadStaData() -> [Statistics] {
        ...
        do {
            ...
            return entities.map { Statistics(totalTime: Int($0.totalTime), totalHatchingTime: Int($0.totalHatchingTime), totalTrainingTime: Int($0.totalTrainingTime), totalExploringTime: Int($0.totalExploringTime), numOfSpecies: Int($0.numOfSpecies), numOfRSpecies: Int($0.numOfRSpecies), numOfSRSpecies: Int($0.numOfSRSpecies), numOfSSRSpecies: Int($0.numOfSSRSpecies), numOfStageTwoSpecies: Int($0.numOfStageTwoSpecies), numOfItems: Int($0.numOfItems), numOfMap: Int($0.numOfMap), numOfFinishedMap: Int($0.numOfFinishedMap), numOfCoins: Int($0.numOfCoins)) }
        } catch {
