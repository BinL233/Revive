...
struct SpeciesPanel_ios17: View {
    ...
    @State var isSpeciesImageDetailOpen = false
    
    var body: some View {
        @Bindable var manager = manager
        
        if isSpeciesImageDetailOpen {
            ZStack {
                ...
                VStack {
                    HStack {
                        Spacer()
                        Button {
                            withAnimation(.bouncy) {isSpeciesImageDetailOpen = false}
                        } label: {
                                ...
                                ZStack {
                                    ...
                                    VStack {
                                        HStack {
                                            Spacer()
                                            Button {
                                                withAnimation(.bouncy) {isSpeciesImageDetailOpen = true}
                                            } label: {
