...
@available(iOS 17.0, *)
struct SpeciesPanelName_ios17: View {
    ...
    var body: some View {
        ...
        HStack {
            ZStack {
                ...
                // Friendship details
                if (details) {
                    SpeciesFriendshipDetails_ios17(details: $details)
...
@available(iOS 16.0, *)
struct SpeciesPanelName_ios16: View {
    ...
    var body: some View {
        HStack {
            ZStack {
                ...
                // Friendship details
                if (details) {
                    SpeciesFriendshipDetails_ios16(details: $details)
                        .frame(width: 46, height: 38)
                }
            }
