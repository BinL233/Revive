...
//                }
            ...
            Text(manager.timeStringGetter())
                ...
                .font(.system(size: 35))
                .foregroundStyle(Color.cBlackBrown)
                .onChange(of: manager.timeStringGetter()) { _ in
                    timerTick()
                }
        }
    }
