...
@available(iOS 17.0, *)
struct TrainingComplete_ios17: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                if let species = manager.currTrainingSpecies {
                    ...
                    SpeciesExpBar_ios17(currModule: $manager.mySpecies[manager.getSpeciesIndex(id: manager.currTrainingSpecies?.speciesID ?? 0, date: manager.currTrainingSpecies?.hatchDate ?? Date())], totalExp: intValue, widthPercent: 0.7)
...
@available(iOS 16.0, *)
struct TrainingComplete_ios16: View {
        ...
        ZStack {
            ...
            VStack {
                ...
                if let species = manager.currTrainingSpecies {
                    ...
                    SpeciesExpBar_ios16(currModule: $manager.mySpecies[manager.getSpeciesIndex(id: manager.currTrainingSpecies?.speciesID ?? 0, date: manager.currTrainingSpecies?.hatchDate ?? Date())], totalExp: intValue, widthPercent: 0.7)
                        .shadow(radius: 1, x: 0.5, y: 0.5)
